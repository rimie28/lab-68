...
const ToDoList = () => {
  ...
  return (
    <div className="container p-4 d-flex flex-column gap-2">
      {tasks.map((task) => (
        <div className="task d-flex justify-content-between align-items-center px-4 py-2 border border-1 bg-light rounded-4" key={task.id}>
          <input
          type="checkbox"
          ...
          <span
            className={task.completed ? 'text-decoration-line-through': 'text-decoration-none'}
          >{task.taskTitle}</span>
