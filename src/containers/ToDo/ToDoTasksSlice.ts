...
export const addTask = createAsyncThunk('toDoTasks/addTask', async(taskTitle:string) => {
...
export const deleteTask = createAsyncThunk('toDoTasks/deleteTask', async (id: string) => {
  await axiosAPI.delete(`toDoTasks/${id}.json`);
  return id;
});

export const checkTaskStatus = createAsyncThunk('toDoTasks/checkTaskStatus', async (task: ToDoTask) => {
